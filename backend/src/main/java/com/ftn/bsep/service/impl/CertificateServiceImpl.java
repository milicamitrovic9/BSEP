...
public class CertificateServiceImpl implements CertificateService {
    ...
    @Override
    public void addToKeyStore(Certificate certificate, String keyStoreFile) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {
